#in the Indicator_Api file we calculate the values of the bollinger bands indicator once the correct parameters is passed to the right function through our request.
